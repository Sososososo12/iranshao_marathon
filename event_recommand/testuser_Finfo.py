...
input_race_id = 597
filename = r'./based/all_user_filtered.xlsx'
...
for num in range(14001,int(user_id_len)):
    ...
    print('已载入第' + str(num) + '个用户信息' + 'user_id为：' + user_id_set[num] + '\n')
    time.sleep(1)
...
data1.to_excel(u'./yuan/alluser_iFnfo_test16630.xls', index=False, encoding='"utf_8_sig')
print('14001-16630的用户信息写入完成！')
